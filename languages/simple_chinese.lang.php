...
DEFINE('_TITLE','入侵检测系统控制台 '.$BASE_installID);
...
DEFINE('_MONTH','月'); //NEW
DEFINE('_YEAR','年'); //NEW
DEFINE('_ALERTGROUP','警报组'); //NEW
DEFINE('_ALERTTIME','告警时间'); //NEW
DEFINE('_CONTAINS','包含'); //NEW
DEFINE('_DOESNTCONTAIN','不包含'); //NEW
DEFINE('_SOURCEPORT','源端口'); //NEW
DEFINE('_DESTPORT','目标端口'); //NEW
DEFINE('_HAS','有'); //NEW
DEFINE('_HASNOT','没有'); //NEW
DEFINE('_PORT','端口'); //NEW
DEFINE('_FLAGS','标志位'); //NEW
DEFINE('_MISC','杂项'); //NEW
DEFINE('_BACK','返回'); //NEW
DEFINE('_DISPYEAR','{ 年 }'); //NEW
DEFINE('_DISPMONTH','{ 月 }'); //NEW
DEFINE('_DISPHOUR','{ 时 }'); //NEW
DEFINE('_DISPDAY','{ 日 }'); //NEW
DEFINE('_DISPTIME','{ 时间 }'); //NEW
DEFINE('_ADDADDRESS','添加地址'); //NEW
DEFINE('_ADDIPFIELD','添加IP段'); //NEW
DEFINE('_ADDTIME','添加时间'); //NEW
DEFINE('_ADDTCPPORT','添加TCP端口'); //NEW
DEFINE('_ADDTCPFIELD','添加TCP段'); //NEW
DEFINE('_ADDUDPPORT','添加UDP端口'); //NEW
DEFINE('_ADDUDPFIELD','添加UDP段'); //NEW
DEFINE('_ADDICMPFIELD','添加ICMP段'); //NEW
DEFINE('_ADDPAYLOAD','增加payload'); //NEW
DEFINE('_MOSTFREQALERTS','最常见告警'); //NEW
DEFINE('_MOSTFREQPORTS','最常见端口'); //NEW
DEFINE('_MOSTFREQADDRS','最常见的IP地址'); //NEW
DEFINE('_LASTALERTS','最后告警'); //NEW
DEFINE('_LASTPORTS','最后端口'); //NEW
DEFINE('_LASTTCP','最后TCP告警'); //NEW
DEFINE('_LASTUDP','最后UDP告警'); //NEW
DEFINE('_LASTICMP','最后ICMP告警'); //NEW
DEFINE('_QUERYDB','查询数据库'); //NEW
DEFINE('_QUERYDBP','Query+DB'); //NEW - Equals to _QUERYDB where spaces are '+'s. 
                                //Should be something like: DEFINE('_QUERYDBP',str_replace(" ", "+", _QUERYDB));
DEFINE('_SELECTED','所选'); //NEW
DEFINE('_ALLONSCREEN','整页'); //NEW
DEFINE('_ENTIREQUERY','全部'); //NEW
DEFINE('_OPTIONS','选项'); //NEW
DEFINE('_LENGTH','长度'); //NEW
DEFINE('_CODE','代码'); //NEW
DEFINE('_DATA','数据'); //NEW
DEFINE('_TYPE','类型'); //NEW
DEFINE('_NEXT','下一个'); //NEW
DEFINE('_PREVIOUS','上一个'); //NEW
...
$page_title = _ALERT;DEFINE('_CREATEGROUPS','建立群组');
...
DEFINE('_SOURCEIP','源IP'); //NEW
DEFINE('_DESTIP','目标IP'); //NEW
...
DEFINE('_ROLEADMIN','角色管理');
DEFINE('_FRMROLEID','角色ID:');
DEFINE('_FRMROLENAME','角色名称:');
DEFINE('_FRMROLEDESC','说明:');

//base_useradmin.php
DEFINE('_SUBMITQUERY','创建'); //NEW
DEFINE('_UPDATEUSER','更新用户'); //NEW
DEFINE('_USERADMIN','用户管理');
DEFINE('_FRMFULLNAME','全名:');
DEFINE('_FRMROLE','角色:');
DEFINE('_FRMUID','用户ID:');

//admin/index.php
DEFINE('_BASEADMIN','管理');
...
DEFINE('_EMAILALERTSFULL','通过邮件发送警告 (全部)');
DEFINE('_EMAILALERTSSUMM','通过邮件发送警告 (只发摘要)');
...
DEFINE('_DISPSIG','{ 匹配类型 }'); //NEW
DEFINE('_DISPANYCLASS','{ 任何分类 }'); //NEW
DEFINE('_DISPANYPRIO','{ 任何优先级 }'); //NEW
DEFINE('_DISPANYSENSOR','{ 任何传感器 }'); //NEW
DEFINE('_DISPADDRESS','{ 地址 }'); //NEW
DEFINE('_DISPFIELD','{ field }'); //NEW
DEFINE('_DISPPORT','{ 端口 }'); //NEW
DEFINE('_DISPENCODING','{ 请选择编码 }'); //NEW
DEFINE('_DISPCONVERT2','{ 请选择编码 }'); //NEW
DEFINE('_DISPANYAG','{ 任何警报组 }'); //NEW
DEFINE('_DISPPAYLOAD','{ payload }'); //NEW
DEFINE('_DISPFLAGS','{ 标志 }'); //NEW
DEFINE('_SIGEXACTLY','精确匹配'); //NEW
DEFINE('_SIGROUGHLY','模糊匹配'); //NEW
DEFINE('_SIGCLASS','Signature Classification'); //NEW
DEFINE('_SIGPRIO','Signature Priority'); //NEW
DEFINE('_SHORTSOURCE','来源'); //NEW
DEFINE('_SHORTDEST','目的'); //NEW
DEFINE('_SHORTSOURCEORDEST','Src or Dest'); //NEW
DEFINE('_NOLAYER4','no layer4'); //NEW
DEFINE('_INPUTCRTENC','编码转换'); //NEW
DEFINE('_CONVERT2WS','在搜索时转换为'); //NEW
...
// NEW
DEFINE('_DISPACTION','PHP 会话处理器，此处没有制定这个工具。请在<CODE>base_conf.php</CODE>里设置<CODE>user_session_path</CODE> 
变量.');
...
DEFINE('_PLOTTYPE','绘图类型:'); //NEW
DEFINE('_TYPEBAR','柱形图'); //NEW
DEFINE('_TYPELINE','线形图'); //NEW
DEFINE('_TYPEPIE','饼图'); //NEW
DEFINE('_CHARTHOUR','{时}'); //NEW
DEFINE('_CHARTDAY','{日}'); //NEW
DEFINE('_CHARTMONTH','{月}'); //NEW
DEFINE('_GRAPHALERTS','绘制'); //NEW
DEFINE('_AXISCONTROLS','X / Y 轴控制'); //NEW
...
DEFINE('_QANORMALD','正常视图'); //NEW
DEFINE('_QAPLAIND','简单视图'); //NEW
DEFINE('_QANOPAYLOAD','使用快速日志记录，因此有效负载被丢弃'); //NEW
...
DEFINE('_QCTCPFLAGS','TCP flag');
DEFINE('_QCTCPFIELD','TCP 字段');
DEFINE('_QCUDPPORTS','UDP 端口');
DEFINE('_QCLAYER4CRIT','协议准则'); //NEW
...
DEFINE('_QCMETACRIT','查询条件');
DEFINE('_QCIPCRIT','选择协议');
DEFINE('_QCPAYCRIT','选择编码');
DEFINE('_QCTCPCRIT','TCP协议');
DEFINE('_QCUDPCRIT','UDP协议');
DEFINE('_QCICMPCRIT','ICMP协议');
...
DEFINE('_QFRMTIMEA','时间戳递增');
DEFINE('_QFRMTIMED','时间戳递减');
DEFINE('_QFRMSIG','特征');
DEFINE('_QFRMSIP','源IP地址');
DEFINE('_QFRMDIP','目标IP地址');
...
DEFINE('_BSTPROFILEBY','选择时间'); //NEW
DEFINE('_TIMEON','on'); //NEW
DEFINE('_TIMEBETWEEN','between'); //NEW
DEFINE('_PROFILEALERT','生成警报'); //NEW
